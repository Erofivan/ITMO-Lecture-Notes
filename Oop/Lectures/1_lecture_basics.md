...
![[../Src/Pasted image 20251018124527.png]]
...
- Класс самолёта (plane) – для симулятора полётов и для сервиса бронирования мест понадобятся совершенно разные уровни детализации. В одном, например, нужны будут законы физики и внутреннее устройство кабины, а в другом только кресла.
  ![[../Src/Pasted image 20251014183124.png]]
...
![[../Src/Pasted image 20251015003015.png]]
...
![[../Src/Pasted image 20251015160340.png]]
...
![[../Src/Pasted image 20251015152811.png]]
Виды композиции:
- Ассоциация
- Агрегация
...
![[../Src/Pasted image 20251015153916.png]]
##### 8) Ассоциация
...
![[../Src/Pasted image 20251015153059.png]]
