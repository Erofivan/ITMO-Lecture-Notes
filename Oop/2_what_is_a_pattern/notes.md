...
Другими словами, имея алгоритм (рецепт) вы можете в точности (с поправкой на ваши кулинарные способности) воссоздать то или иное блюдо.

Имея же чертёж вы будете понимать примерный план, но построете ли вы собор? Дать вам сейчас чертёж и что вы будете с ним делать? ("...глядят как в афишу коза..." - писал Маяковский) Да, можно ориентироваться на него, но без должного образования ничего воссоздать не получится, да и даже если получится, то у всех будут разные алгоритмы.
...
Короче говоря, самая большая претензия к паттернам заключается в том, что "молодые" разработчики учат 20 паттернов подряд, после чего стараются подогнать под них всё, что только возможно, забывая о том, как они писали код до этого. Из-за этого некоторые вещи слишком сильно усложняются. Да и в целом нехорошо подгонять всё, так сказать, под одну гребёнку; паттерны - это просто типовые решения для типовых задач, инструменты. В тех случаях когда задача не типовая, или же ещё нет кого-то общеустоявшегося мнения, то и само понятие паттерна не имеет смысла. В таких случаях надо просто решить задачу нормальными способами. Круто, когда паттерн может нам пригодится, но и подгонять под него "лишь бы было" не стоит. 

В общем пишите просто хороший код, но знайте паттерны, чтобы эти самые паттерны видить и в случае необходимости суметь применить.
