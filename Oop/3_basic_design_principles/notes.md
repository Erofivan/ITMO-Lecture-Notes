...
Помимо паттернов проектирования, существуют также так называемые *принципы проектирования*. 
...
Принципы определяют *способ мышления* при проектировании, а паттерны предоставляют *готовые решения*, которые обычно следуют этим принципам.

Другими словами, если паттерны представляют собой типовые решения для часто встречающихся задач, то принципы — это более общие идеи, отражающие подход к построению качественной архитектуры и стилю мышления разработчика. Это те вещи, которые в целом надо держать в голове при разработке ~~у меня был план и я его придерживался~~. То есть пишем код, держа в голове принципы, а уже, если видим какую-то типовую проблему, то примяенем паттерны. 

Паттерны, как правило, следуют принципам, а не наоборот.

Поэтому прежде, чем переходить к изучению конкретных паттернов, важно изучить эти самые фундаментальные принципы, на которых строится надежное и понятное программное обеспечение, а также сами паттерны (ещё раз: паттерны следуют принципам, поэтому сначала изучаем принципы, а уже потом паттерны).

В этом конспекте мы рассмотрим самые основные концепции, и научимся применять их на практике, а уже в следующих конспектах эти идеи постепенно разовьются в принципы SOLID, GRASP, после чего мы приступим к изучению паттернов проектирования.
