...
- **Leaf** (Терминальный узел/Лист) — терминальный узел дерева, который не содержит вложенных элементов
- **Composite** (Агрегатные узлы/Композит) — составной узел, который содержит коллекцию дочерних элементов
