...
// Здесь преподаватель демонстрирует использование разработанной системы выражений
...
//
// Комментарий преподавателя показывает идею:
// Есть две взаимозависимые формулы:
// c = (x * y) + a
// a = c + 2
//
// Это циклическая зависимость — a зависит от c, c зависит от a.
// Преподаватель показывает, как система справляется с неизвестными переменными.
