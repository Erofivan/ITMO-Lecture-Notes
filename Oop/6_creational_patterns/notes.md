...
// Все конкретные кнопки должны реализовать этот интерфейс
// Интерфейс продукта
...
Вспомним пример с диалоговыми окнами. Представьте, что помимо кнопки нам нужно создать ещё текстовое поле и полосу прокрутки. Все эти элементы должны быть в одном стиле!
...
Представьте заказ с множеством опциональных параметров: комментарии, телефон получателя, время доставки, подарочная упаковка и т.д. Builder решает эту проблему изящно.
