...
- product тип, создаваемых объектов наследники реализуют создание в конкретных creator’ах
![](src/factory_method/factory_method_scheme.png)

Рассмотрим ещё один пример: представьте, что мы пишем систему обработки заказов
